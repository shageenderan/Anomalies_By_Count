# TODO: Use a decaying threshold
# TODO: When anomaly is detected, continue to notify for an arbitrary number of frames, then normalize  
...
capture = cv2.VideoCapture(os.path.join(VIDEO_DIR, 'anomalies/house-attack.mp4'))
